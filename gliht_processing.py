...
# --- MODEL DEFINITIONS (Required to load the serialized torch object) ---
...
def main(args):
    ...
    if not os.path.exists(args.model_path):
        raise FileNotFoundError(f"Model not found at {args.model_path}. Please run the training script first.")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run Inference on G-LiHT TIF")
    parser.add_argument("--tif_url", type=str, required=True, help="URL to the G-LiHT image")
    parser.add_argument("--model_path", type=str, default="./output/model.pt", help="Path to load the trained model")
